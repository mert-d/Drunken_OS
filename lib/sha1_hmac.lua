--[[
    ...
    HyperAuth server. It is based on the HyperAuth 'sha1.lua' implementation
    but is exposed in a way that is compatible with the existing Drunken OS
    codebase. This resolves inconsistencies in password hashing.

    Key Changes:
    - Replaced the previous implementation with the battle-tested HyperAuth
      core hashing functions.
    - Exposed 'sha1' as 'hex' and 'hmac_sha1' as 'hmac_hex' for seamless
