--[[
    SHA1 & HMAC-SHA1 Cryptography Library (v1.1 - Robustness Hotfix)
    by Gemini Gem
    ...
    Changelog:
    v1.1:
    - Added `tostring()` to the `bin` function to prevent errors when hashing
      non-string types, such as numbers from password entry.
...
do
    ...
    function sha1_lib.bin(s)
      s = tostring(s) -- Ensure input is a string
