...
return {
    ...
    packages = {
        ...
        auditor = {
            ...
            include_shared = false, -- Turtles might not need UI libs like theme/utils
            needs_setup = true,
            setup_type = "auditor"
        },
        ...
        arcade_server = {
             ...
             files = { "servers/Drunken_Arcade_Server.lua", "lib/sha1_hmac.lua" },
             include_shared = false
        }
    }
}
